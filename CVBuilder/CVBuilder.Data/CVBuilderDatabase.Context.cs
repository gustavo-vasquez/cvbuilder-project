...
namespace CVBuilder.Data
{
    ...
    public partial class CVBuilderEntities : DbContext
    {
        ...
        public virtual int usp_PersonalDetails_Create(string name, string lastname, string email, string profession, byte[] photo, string mimeType, string address, string city, Nullable<int> postalCode, Nullable<short> areaCodeLP, Nullable<int> linePhone, Nullable<short> areaCodeMP, Nullable<int> mobilePhone, string country, string summary, string summaryCustomTitle, Nullable<bool> summaryIsVisible, string webPageUrl, string linkedInUrl, string githubUrl, string facebookUrl, string twitterUrl, Nullable<int> id_curriculum)
        {
            var nameParameter = name != null ?
                new ObjectParameter("name", name) :
                new ObjectParameter("name", typeof(string));
